...
- 🐍 Desenvolvedor Python (Flask, FastAPI e Django)
- ☁️ Entusiasta de Cloud Computing (AWS)
...
🚀 Alguns projetos que representam minha atuação:

- 🔹 Integrações entre ERPs e APIs REST
- 🔹 Automações utilizando Python
- 🔹 Aplicações desenvolvidas com Flask e FastAPI
- 🔹 Soluções para infraestrutura e monitoramento
